            ...
            <div className="row">
              <div className="col col--8 col--offset-2">
                <p>
                  ...
                  in architectural leadership, full-stack development, quality
                  assurance, and research. I am passionate about creating robust
                  and scalable software solutions, ensuring compliance with
                  architectural standards, and fostering best practices within
                  development teams. My expertise covers a wide range of
                  technologies and methodologies, from microservices and
                  cloud-native deployments to agile software development
                  environments.
                </p>
              </div>
            </div>
